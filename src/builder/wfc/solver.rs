...
impl Solver {
    ...
    pub fn iteration(&mut self, map: &mut Map, rng: &mut ThreadRng) -> bool {
        ...
        let remaining_index = if !neighbors_exist {
            rng.gen_range(0..self.remaining.len())
        } else {
            0usize
        };
        ...
        if neighbors == 0 {
            ...
            let new_chunk_idx = rng.gen_range(0..self.constraints.len());
            ...
            if possible_options.is_empty() {
                ...
                let new_chunk_idx = if possible_options.len() == 1 {
                    ...
                    rng.gen_range(0..possible_options.len() as i32)
                };
